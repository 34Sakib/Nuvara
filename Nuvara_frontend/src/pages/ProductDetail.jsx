  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto px-4 py-20 text-center animate-pulse">
        <div className="h-6 w-32 bg-border rounded mb-6 mx-auto"></div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start mb-16">
          <div className="h-96 bg-border rounded-lg animate-pulse"></div>
          <div className="space-y-6">
            <div className="h-10 w-2/3 bg-border rounded animate-pulse"></div>
            <div className="h-6 w-1/3 bg-border rounded animate-pulse"></div>
            <div className="h-20 bg-border rounded animate-pulse"></div>
